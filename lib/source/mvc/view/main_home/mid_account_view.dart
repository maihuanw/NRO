...
class MidAccountView extends StatefulWidget {
  const MidAccountView({super.key});

  @override
  _MidAccountViewState createState() => _MidAccountViewState();
}

class _MidAccountViewState extends State<MidAccountView> {
