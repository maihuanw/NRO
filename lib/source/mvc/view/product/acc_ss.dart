...
class GameAccountShopScreen extends StatefulWidget {
  const GameAccountShopScreen({super.key});

  @override
  _GameAccountShopScreenState createState() => _GameAccountShopScreenState();
}

class _GameAccountShopScreenState extends State<GameAccountShopScreen> {
